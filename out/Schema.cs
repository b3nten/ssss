...
w.Write((UInt32)0);
			...
			{
				w.Write((ushort)0);
								var bytes2 = System.Text.Encoding.UTF8.GetBytes(it.WorldName);
				w.Write((uint)bytes2.Length);
				w.Write(bytes2);
			...
			{
								var bytes4 = System.Text.Encoding.UTF8.GetBytes(kv1.Key);
				w.Write((uint)bytes4.Length);
				w.Write(bytes4);
					...
					static public void Deserialize(World it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				break;
					case 0:
								{
					uint strLen7 = r.ReadUInt32();
					var strBytes7 = r.ReadBytes((int)strLen7);
					it.WorldName = System.Text.Encoding.UTF8.GetString(strBytes7);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes8);
				}
				...
				while (r.BaseStream.Position - startPos1 < mapLength1)
				{
					...
					uint value1;
									{
					uint strLen9 = r.ReadUInt32();
					var strBytes9 = r.ReadBytes((int)strLen9);
					key1 = System.Text.Encoding.UTF8.GetString(strBytes9);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes10);
				}
...
w.Write((UInt32)0);
			...
			{
								var bytes13 = System.Text.Encoding.UTF8.GetBytes(kv2.Key);
			...
			{
								var bytes14 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
				w.Write((uint)bytes14.Length);
				w.Write(bytes14);
			...
			{
				w.Write((ushort)1);
								var bytes15 = System.Text.Encoding.UTF8.GetBytes(it.Name);
			...
			{
								var bytes16 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
				w.Write((uint)bytes16.Length);
				w.Write(bytes16);
					...
					static public void Deserialize(Character it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes17);
				}
				...
				while (r.BaseStream.Position - startPos1 < mapLength1)
				{
					...
					key1 = System.Text.Encoding.UTF8.GetString(strBytes18);
				}
				...
				while (r.BaseStream.Position - startPos2 < mapLength2)
				{
					...
					sbyte value2;
									{
					uint strLen19 = r.ReadUInt32();
					var strBytes19 = r.ReadBytes((int)strLen19);
					key2 = System.Text.Encoding.UTF8.GetString(strBytes19);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					List<double> value0;
									{
					uint strLen20 = r.ReadUInt32();
					var strBytes20 = r.ReadBytes((int)strLen20);
					key0 = System.Text.Encoding.UTF8.GetString(strBytes20);
				}
				...
				break;
					case 1:
								{
					uint strLen21 = r.ReadUInt32();
					var strBytes21 = r.ReadBytes((int)strLen21);
					it.Name = System.Text.Encoding.UTF8.GetString(strBytes21);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					EquipmentSlot value0;
									{
					uint strLen22 = r.ReadUInt32();
					var strBytes22 = r.ReadBytes((int)strLen22);
					key0 = System.Text.Encoding.UTF8.GetString(strBytes22);
				}
...
w.Write((UInt32)0);
			...
			{
								var bytes23 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
...
w.Write((UInt32)0);
			...
			{
				w.Write((ushort)0);
								var bytes25 = System.Text.Encoding.UTF8.GetBytes(it.Name);
				w.Write((uint)bytes25.Length);
				w.Write(bytes25);
...
w.Write((UInt32)0);
			...
			{
								var bytes27 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
					...
					static public void Deserialize(Loot it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes28);
				}
...
w.Write((UInt32)0);
			...
			{
				w.Write((ushort)9);
								var bytes29 = System.Text.Encoding.UTF8.GetBytes(it.Description);
			...
			{
				w.Write((ushort)1);
								var bytes30 = System.Text.Encoding.UTF8.GetBytes(it.Title);
			...
			{
								var bytes31 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
			...
			{
				var e1 = kv0.Value[i1];
								var bytes32 = System.Text.Encoding.UTF8.GetBytes(e1);
					...
					static public void Deserialize(Quest it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				break;
					...
					it.Description = System.Text.Encoding.UTF8.GetString(strBytes34);
				}
				...
				break;
					...
					it.Title = System.Text.Encoding.UTF8.GetString(strBytes35);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes36);
				}
				...
				while (r.BaseStream.Position - startPos1 < listLength1)
				{
					...
					e1 = System.Text.Encoding.UTF8.GetString(strBytes37);
				}
...
w.Write((UInt32)0);
			...
			{
				var e0 = it.Tags[i0];
								var bytes39 = System.Text.Encoding.UTF8.GetBytes(e0);
			...
			{
								var bytes40 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
				w.Write((uint)bytes40.Length);
				w.Write(bytes40);
			
								var bytes41 = System.Text.Encoding.UTF8.GetBytes(kv0.Value);
					...
					static public void Deserialize(Item it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				while (r.BaseStream.Position - startPos0 < listLength0)
				{
					...
					e0 = System.Text.Encoding.UTF8.GetString(strBytes43);
				}
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					value0 = System.Text.Encoding.UTF8.GetString(strBytes45);
				}
				...
				break;
					...
					it.Name = System.Text.Encoding.UTF8.GetString(strBytes46);
				}
...
w.Write((UInt32)0);
			...
			{
				w.Write((ushort)0);
								var bytes47 = System.Text.Encoding.UTF8.GetBytes(it.SlotName);
				w.Write((uint)bytes47.Length);
				w.Write(bytes47);
					...
					static public void Deserialize(EquipmentSlot it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				switch (fieldId)
				{
					...
					it.SlotName = System.Text.Encoding.UTF8.GetString(strBytes48);
				}
...
w.Write((UInt32)0);
			...
			{
								var bytes49 = System.Text.Encoding.UTF8.GetBytes(kv0.Key);
					...
					static public void Deserialize(LootEntry it, BinaryReader r)
		{
			...
			while (r.BaseStream.Position - startPos < length)
			{
				...
				while (r.BaseStream.Position - startPos0 < mapLength0)
				{
					...
					key0 = System.Text.Encoding.UTF8.GetString(strBytes50);
				}
